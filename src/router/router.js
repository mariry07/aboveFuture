...
export const otherRouter = {
    ...
    children: [
        ...
        { path: 'details_hostConfig', title: '设备详情', name: 'details_hostConfig', component: () => import('@/views/fire-water/host-config/detailsHostConfig.vue') },
        { path: 'detail_camera', title: '摄像头详情', name: 'detail_camera', component: () => import('@/views/application-config/camera/detailCamera.vue') },
        { path: 'detail_lanfault', title: '故障详情', name: 'detail_lanfault', component: () => import('@/views/fire-lan/fire-fault/detailfirefault.vue') },
        { path: 'details_firehost', title: '主机详情', name: 'details_firehost', component: () => import('@/views/fire-lan/fire-host/firehostDetail.vue') },
