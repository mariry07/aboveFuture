          ...
          <Row>
            <Form ref="searchForm" :model="searchForm" inline :label-width="70" class="search-form">
              ...
              <Form-item label="任务状态" prop="status">
                ...
                <Form-item label="巡更人员" prop="doUserId">
...
import {getPlanTaskData,getAllUserData,getPatrolPlanTask, deletePatrolPlanTask} from "@/api/index";
export default {
  name: "planTask",
  components: {
    circleLoading
        ...
        },
        {
        ...
        },
         {
          ...
          key: "finishedTime",
           render: (h, params) => {
             let re = "";
             if (params.row.finishedTime == null) {
               re = "未完成";
             } else{
               re = "已停止";
             }
    ...
    delAll() {
      ...
      this.$Modal.confirm({
          ...
          onOk: () => {
              ...
              deletePatrolPlanTask(ids).then(res => {
