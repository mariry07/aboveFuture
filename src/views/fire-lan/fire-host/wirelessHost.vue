        ...
        <div style="width:100%; float:left;">
          ...
          <div style="width:50%; float:left;">
            ...
            <FormItem label="主机类型:" prop="deviceType">
              <Select v-model="hostConfigForm.deviceType" disabled  placeholder="物联中继主机">
                <Option :value="1001">物联中继主机</Option>
              </Select>
            </FormItem>
...
export default {
  ...
  methods: {
    ...
    getdeviceVersion(){
      //this.loading=true;
      getdeviceVersion({deviceType:'14'}).then(res=>{
        if(res.status === 1){
